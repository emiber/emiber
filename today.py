# Based on https://github.com/Andrew6rant/Andrew6rant by Andrew Grant
# The original repository has no LICENSE file; attribution retained per request.
import datetime
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2001, 1, 1)) # "uptime" start = software career; adjust to taste
